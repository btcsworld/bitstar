...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"lightgreen\">" + qVolume + " BTS" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"lightred\">" + qVolume + " BTS" + "</font></b>");
    } else {
        ui->volumeBox->setText("<b><font color=\"lightblue\">" + qVolume + " BTS" + "</font></b>");
    }
