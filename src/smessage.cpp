// Copyright (c) 2014 The Bitstar developers
...
void ThreadSecureMsg(void* parg)
{
    ...
    RenameThread("Bitstar-smsg"); // Make this thread recognisable
...
void ThreadSecureMsgPow(void* parg)
{
    ...
    RenameThread("Bitstar-smsg-pow"); // Make this thread recognisable
